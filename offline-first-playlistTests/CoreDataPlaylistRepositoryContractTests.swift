...
final class CoreDataPlaylistRepositoryContractTests: XCTestCase {
    ...
    private func makeRepository() throws -> CoreDataPlaylistRepository {
        let stack = try CoreDataStack.inMemory()
        return CoreDataPlaylistRepository(context: stack.viewContext)
    }
}
